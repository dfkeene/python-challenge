...
#The net total amount of PL over the entire period
#Calculate the changes in PL over the entire period, then find the average of those changes
...
with open(budget_data_csv_path, newline="") as csvfile:
    ...
    for row in csv_reader:
        ...
        # Net total amount of PL over the entire period
    ...
    #sum and average of the changes in PL over the entire period
    sum_profit_loss = sum(profit_loss_changes)
    average_profit_loss = round(sum_profit_loss/(count_months - 1), 2)

    # highest and lowest changes in PL over the entire period
    highest_change = max(profit_loss_changes)
    lowest_change = min(profit_loss_changes)

    #Locate the index value of highest and lowest changes in PL over the entire period
